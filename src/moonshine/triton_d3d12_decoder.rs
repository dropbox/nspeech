...
// ── Pre-compiled DXIL bytecode (generated by Triton AOT → HLSL → hassle-rs DXC) ──

// Triton-compiled kernels
const DXIL_MATMUL_F32W_64: &[u8] =
    include_bytes!("../../kernels/out/dxil/matmul_f16a_f32w_64x64x32.dxil");
const DXIL_MATMUL_F32W_32: &[u8] =
    include_bytes!("../../kernels/out/dxil/matmul_f16a_f32w_32x32x32.dxil");
const DXIL_MATMUL_BIAS_F32W_32: &[u8] =
    include_bytes!("../../kernels/out/dxil/matmul_bias_f16a_f32w_32x32x32.dxil");
const DXIL_LAYERNORM_STD_F32IN: &[u8] =
    include_bytes!("../../kernels/out/dxil/layernorm_standard_f32in_640.dxil");
const DXIL_RESIDUAL_ADD_F32: &[u8] =
    include_bytes!("../../kernels/out/dxil/residual_add_f32.dxil");
const DXIL_ADD_BIAS_F32: &[u8] =
    include_bytes!("../../kernels/out/dxil/add_bias_f32_fp16.dxil");
const DXIL_CONVERT_F32_TO_F16: &[u8] =
    include_bytes!("../../kernels/out/dxil/convert_f32_to_f16.dxil");

// GEMV kernels — Triton-compiled, f16 weights (2x bandwidth vs f32)
const DXIL_GEMV_F16W: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_f16w.dxil");
const DXIL_GEMV_BIAS_F16W: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_bias_f16w.dxil");

// Triton-compiled decoder kernels
const DXIL_ATTENTION_DECODE: &[u8] =
    include_bytes!("../../kernels/out/dxil/attention_decode_1d_d80.dxil");
const DXIL_ROPE_INTERLEAVED: &[u8] =
    include_bytes!("../../kernels/out/dxil/rope_interleaved.dxil");
const DXIL_KV_CACHE_APPEND: &[u8] =
    include_bytes!("../../kernels/out/dxil/kv_cache_append.dxil");
const DXIL_ROPE_CACHE_FUSED: &[u8] =
    include_bytes!("../../kernels/out/dxil/rope_cache_fused.dxil");
const DXIL_ROPE_QK_CACHE_FUSED: &[u8] =
    include_bytes!("../../kernels/out/dxil/rope_qk_cache_fused.dxil");
const DXIL_GLU_SILU: &[u8] =
    include_bytes!("../../kernels/out/dxil/glu_silu_fused.dxil");
const DXIL_RESIDUAL_ADD_LAYERNORM: &[u8] =
    include_bytes!("../../kernels/out/dxil/residual_add_layernorm_fused.dxil");
const DXIL_GEMV_BIAS_GLU: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_bias_glu_fused.dxil");
const DXIL_GEMV_RESADD_LN: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_resadd_ln_fused.dxil");
...
impl DecoderKernels {
    fn load(gpu: &Arc<Gpu>) -> Result<Self> {
        let load_pso = |name: &str, dxil: &[u8]| -> Result<ID3D12PipelineState> {
        ...
        Ok(Self {
            gpu: gpu.clone(),
            matmul_f32w_64: load_pso("dec_matmul_f32w_64", DXIL_MATMUL_F32W_64)?,
            matmul_f32w_32: load_pso("dec_matmul_f32w_32", DXIL_MATMUL_F32W_32)?,
            matmul_bias_f32w_32: load_pso("dec_matmul_bias_f32w_32", DXIL_MATMUL_BIAS_F32W_32)?,
            gemv_f16w: load_pso("dec_gemv_f16w", DXIL_GEMV_F16W)?,
            gemv_bias_f16w: load_pso("dec_gemv_bias_f16w", DXIL_GEMV_BIAS_F16W)?,
            layernorm_std_f32in: load_pso("dec_layernorm_std_f32in", DXIL_LAYERNORM_STD_F32IN)?,
            residual_add_f32: load_pso("dec_residual_add_f32", DXIL_RESIDUAL_ADD_F32)?,
            add_bias_f32: load_pso("dec_add_bias_f32", DXIL_ADD_BIAS_F32)?,
            convert_f32_to_f16: load_pso("dec_convert_f32_to_f16", DXIL_CONVERT_F32_TO_F16)?,
            attention_decode: load_pso("dec_attention_decode", DXIL_ATTENTION_DECODE)?,
            rope_interleaved: load_pso("dec_rope_interleaved", DXIL_ROPE_INTERLEAVED)?,
            kv_cache_append: load_pso("dec_kv_cache_append", DXIL_KV_CACHE_APPEND)?,
            rope_cache_fused: load_pso("dec_rope_cache_fused", DXIL_ROPE_CACHE_FUSED)?,
            rope_qk_cache_fused: load_pso("dec_rope_qk_cache_fused", DXIL_ROPE_QK_CACHE_FUSED)?,
            glu_silu: load_pso("dec_glu_silu", DXIL_GLU_SILU)?,
            residual_add_layernorm: load_pso("dec_resadd_ln", DXIL_RESIDUAL_ADD_LAYERNORM)?,
            gemv_bias_glu: load_pso("dec_gemv_bias_glu", DXIL_GEMV_BIAS_GLU)?,
            gemv_resadd_ln: load_pso("dec_gemv_resadd_ln", DXIL_GEMV_RESADD_LN)?,
        })
    }
}
...
#[allow(dead_code)]
const DXIL_GEMV_Q8: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_q8_v2.dxil");
#[allow(dead_code)]
const DXIL_GEMV_Q8_BIAS: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_q8_bias_v2.dxil");
#[allow(dead_code)]
const DXIL_GEMV_Q8_BIAS_GLU: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_q8_bias_glu_v2.dxil");
#[allow(dead_code)]
const DXIL_GEMV_Q8_RESADD_LN: &[u8] =
    include_bytes!("../../kernels/out/dxil/gemv_q8_resadd_ln_v2.dxil");
