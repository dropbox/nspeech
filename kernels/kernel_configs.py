...
METAL_KERNELS = [
    ...
    # ── Matmul + bias (ACTIVATION: 0=none, 1=GELU, 2=SiLU) ──
    ("matmul_bias_fp16_32x32x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 0",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"]),
    ("matmul_bias_fp16_64x64x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 64, 64, 32, 0",
     4, ["cdiv(M, 64)", "cdiv(N, 64)", "1"]),
    ("matmul_bias_fp16_128x128x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 128, 128, 32, 0",
     8, ["cdiv(M, 128)", "cdiv(N, 128)", "1"]),
    ("matmul_bias_gelu_fp16_32x32x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 1",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"]),
    ("matmul_bias_gelu_fp16_64x64x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 64, 64, 32, 1",
     4, ["cdiv(M, 64)", "cdiv(N, 64)", "1"]),
    ("matmul_bias_gelu_fp16_128x128x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 128, 128, 32, 1",
     8, ["cdiv(M, 128)", "cdiv(N, 128)", "1"]),
    ("matmul_bias_silu_fp16_32x32x32", "matmul_bias_fp16",
     "*fp16:16, *fp16:16, *fp16, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 2",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"]),
    # ── Mixed precision (f16 activations, f32 weights) ──
    ("matmul_bias_gelu_f16a_f32w_32x32x32", "matmul_bias_f16a_f32w",
     "*fp16:16, *fp32:16, *fp32, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 1",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"],
     {"targets": ["hlsl"]}),
    ("matmul_bias_silu_f16a_f32w_32x32x32", "matmul_bias_f16a_f32w",
     "*fp16:16, *fp32:16, *fp32, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 2",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"],
     {"targets": ["hlsl"]}),
...
HLSL_EXTRA_KERNELS = [
    ...
    ("matmul_bias_f16a_f32w_32x32x32", "matmul_bias_f16a_f32w",
     "*fp16:16, *fp32:16, *fp32, *fp16:16, i32, i32, i32, i32, i32, i32, i32, i32, i32, 32, 32, 32, 0",
     4, ["cdiv(M, 32)", "cdiv(N, 32)", "1"]),
