...
fn main() -> Result<()> {
    ...
    // 3s chunks provide good balance between latency and quality
    const CHUNK_SECONDS: f32 = 3.0;  // Larger chunks = more encoder context
    const OVERLAP_SECONDS: f32 = 0.5; // Overlap for acoustic context
